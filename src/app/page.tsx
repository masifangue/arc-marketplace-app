...
function StatCard({ label, value }: { label: string; value: string }) {
  return (
    <div className="glass-card p-6 text-center">
      <p className="text-3xl font-heading font-bold text-[#6C9EA9]">{value}</p>
    ...
    <div className="space-y-16">
      ...
      <section className="text-center pt-16 pb-8">
        <h1 className="text-5xl sm:text-6xl lg:text-7xl font-heading font-bold mb-6">
          ...
          <span className="text-[#6C9EA9] glow-text">Marketplace</span>
        </h1>
      ...
      <section className="max-w-4xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="glass-card p-6">
            <div className="w-10 h-10 rounded-full bg-[#6C9EA9]/10 flex items-center justify-center mb-4">
              <span className="text-[#6C9EA9] font-bold">1</span>
            </div>
          ...
          <div className="glass-card p-6">
            <div className="w-10 h-10 rounded-full bg-[#406A83]/10 flex items-center justify-center mb-4">
              <span className="text-[#406A83] font-bold">2</span>
            </div>
          ...
          <div className="glass-card p-6">
            <div className="w-10 h-10 rounded-full bg-[#6C9EA9]/10 flex items-center justify-center mb-4">
              <span className="text-[#6C9EA9] font-bold">3</span>
            </div>
